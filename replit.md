...
- **Test Suite:** 92 pytest tests across 4 files in `artifacts/syrabit-backend/tests/` covering board normalization (35), chunking (16), prompts (29), and RAG pipeline (12). Config in `pyproject.toml`.
