...
- **Admin Panel:** A comprehensive interface for content editing, CMS, blog publishing, SEO management, QA review, and system intelligence. Admin notification preferences support custom alert sound file uploads (MP3/WAV, max 500KB) stored in Supabase object storage, with `Audio` element playback for custom chimes.
