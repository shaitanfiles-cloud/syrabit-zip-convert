...
- **Chat Latency:** English queries: target sub-1s TTFT (Stage 1 best-effort 200ms + direct LLM ~0.3-0.5s). Cached queries: ~0.3s. Casual queries: instant (~0s). Assamese: ~1.4-2.1s. TTFT timeout: 0.5s (down from 0.8s). System prompt cap: 10K chars (down from 24K). Payload cap: 12K chars (down from 24K). Default model: `meta-llama/llama-4-scout-17b-16e-instruct` (Groq). Max tokens: free=512, starter=768, pro=1024.
