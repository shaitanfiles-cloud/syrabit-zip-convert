...
- **Chat Latency:** Streaming TTFT ~2.2s (web search adds ~1.5s), total ~2.3s. SLM pool TTFT timeout: 1.0s. Stage 1 timeout: 0.8s. Search scope timeout: 0.35s (fire-and-forget). Web search timeout: 1.5s (DDG timeout: 1.2s). Default model: `meta-llama/llama-4-scout-17b-16e-instruct` (Groq). Web search skipped for casual intent only. Max tokens: free=1024, starter=1536, pro=2048.
