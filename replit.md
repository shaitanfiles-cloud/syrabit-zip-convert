...
- **Library Page**: Board/Class dropdown filters + dynamic stream chips; search autocomplete across name/tags/class/stream/board
- **Lesson Pages (SeoTopicPage)**: Collapsible Table of Contents from markdown headings; heading IDs for anchor links; blog-style layout with breadcrumb, content type tabs, related topics, prev/next navigation
