  ...
  return (
    <div style={{ background: '#fff', minHeight: '100vh', position: 'relative' }}>
      ...
      <footer
        ...
        data-testid="pyq-continue-footer"
      >
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
          <p style={{ fontSize: 13, fontWeight: 600, color: '#4b5563', marginBottom: 4 }}>
            Continue your exam prep with Syrabit.ai
          </p>
          <p style={{ fontSize: 12, color: '#6b7280', marginBottom: 14 }}>
            {pyqMeta.subject ? `Browse ${pyqMeta.subject} notes, MCQs, and ask Syra AI` : 'Browse notes, MCQs, and ask Syra — your AssamBoard exam tutor'}
          </p>
          <div style={{ display: 'inline-flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center' }}>
            <a
              ...
              data-testid="pyq-cta-library"
            >
              📚 Browse Library
            </a>
            <a
              href={pyqMeta.subject
              ...
              data-testid="pyq-cta-chat"
            >
              ✨ Ask Syra AI
            </a>
            {pyqMeta.board && (
              <a
                href={`/${pyqMeta.board.toLowerCase()}/class-12/${(pyqMeta.subject || '').toLowerCase().split(' ')[0] || ''}`.replace(/\/$/, '')}
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: 6,
                ...
                data-testid="pyq-cta-subject"
              >
                {pyqMeta.subject || pyqMeta.board} notes →
              </a>
            )}
          </div>
        </div>
