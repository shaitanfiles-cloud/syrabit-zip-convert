...
const POPULAR = [
  ...
  { label: 'Class 12 Economics',   href: '/ahsec/class-12/economics',   board: 'AHSEC' },
  ...
  { label: 'B.Com Accountancy',    href: '/library?stream=commerce',    board: 'Degree' },
];
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3">
          {POPULAR.map((s) => (
            ...
            >
              ...
              <span className="text-sm font-semibold text-foreground leading-snug group-hover:text-violet-600 transition-colors">
                {s.label}
              </span>
            </Link>
          ))}
