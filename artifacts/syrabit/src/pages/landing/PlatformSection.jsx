      ...
      >
        {SECTIONS.map((s) => (
          ...
          >
            ...
            <h3 className="text-white mb-2 relative z-10" style={{ fontWeight: 700, fontSize: '1rem' }}>{s.title}</h3>
            <p className="text-sm leading-relaxed relative z-10" style={{ color: 'rgba(255,255,255,0.65)' }}>{s.desc}</p>
          </motion.div>
        ))}
      </motion.div>
    </section>
