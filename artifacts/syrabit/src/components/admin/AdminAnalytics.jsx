...
import { Loader2, RefreshCw, Eye, Globe, TrendingUp, Users, Search, BookOpen, Bot,
  ...
  CheckCircle, AlertCircle, AlertTriangle, Link as LinkIcon, Calendar, MessageSquare,
  Smartphone, Monitor, Tablet, Activity, Clock } from 'lucide-react';
import {
    ...
    <div className="p-6 space-y-5">
      ...
      {tab === 'overview' && (
        <>
          ...
          {/* ── Device Breakdown + Top Countries + New vs Returning ── */}
