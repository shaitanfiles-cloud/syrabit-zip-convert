      ...
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/10" style={{ background: 'rgba(255,255,255,0.03)' }}>
          <div className="flex items-center gap-3 min-w-0">
            <Book size={20} className="text-violet-400 flex-shrink-0" />
            <div className="min-w-0">
              <h3 className="text-lg font-bold text-white truncate">{item.title || 'Untitled'}</h3>
              <p className="text-xs text-white/40">{(item.content || '').length} chars</p>
            </div>
          </div>
